# Mastery profile showing per-skill scores and reasoning
...
- Show per-skill mastery level, AI state, scores, evidence count, last updated, and “why this status?” details.
- Include badges and progress bars.
