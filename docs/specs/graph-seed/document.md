# Skill graph seed and dependency graph subset for FDP domain
...
- Seed FDP skill nodes and prerequisite edges.
- Seed misconception framework subset.
- Seed single student and initial mastery rows.
- Support idempotent seeding.
