# Developer evidence log for transparency and debugging
...
- Show raw evidence events with filters/summary.
- Include skill ID, category, correctness, confidence, explanation score, misconception signals, weight, and timestamp.
